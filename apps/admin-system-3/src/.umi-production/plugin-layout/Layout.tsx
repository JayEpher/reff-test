...
/// <reference types="/Users/zhanghe/self/code/Front-end-Architecture/puff-monorepo/apps/admin-system-3/node_modules/@ant-design/pro-components" />
...
import {
  ProLayout,
} from "/Users/zhanghe/self/code/Front-end-Architecture/puff-monorepo/apps/admin-system-3/node_modules/@ant-design/pro-components";
import './Layout.css';
...
const formatMessage = undefined;
  ...
  return (
    <ProLayout
      route={route}
      location={location}
      title={userConfig.title || '@puff/admin-system-3'}
      navTheme="dark"
      siderWidth={256}
      onMenuHeaderClick={(e) => {
        e.stopPropagation();
